...
type BackgroundPositionRef1 = "bottom" | "top";
type BackgroundPositionRef2 = "bottom" | "top";
...
type DisplayRef2 =
  ...
  | "row"
  | "row-group";
type FilterRef1 = "2xl" | "lg" | "md" | "none" | "sm" | "xl" | "xs";
type FilterRef2 = "0" | "50" | "75" | "100" | "125" | "150" | "200";
type FilterRef3 = "0" | "25" | "50" | "75" | "100";
type FilterRef4 = "0" | "15" | "30" | "60" | "90" | "180";
type FilterRef5 = "0" | "25" | "50" | "75" | "100";
type FilterRef6 = "0" | "50" | "100" | "150" | "200";
type FilterRef7 = "0" | "50" | "100";
...
type BreakAfterRef1 =
  ...
  | "page"
  | "right";
type WordBreakRef1 = "all" | "keep" | "normal" | "words";
...
type BoxShadowRef3 =
  ...
  | "xs"
  | TailwindGlobalColor;
type AlignItemsRef1 = "baseline" | "center" | "end" | "start" | "stretch";
type JustifyContentRef1 =
  ...
  | "start"
  | "stretch";
type JustifyItemsRef1 = "center" | "end" | "normal" | "start" | "stretch";
type JustifySelfRef1 = "auto" | "center" | "end" | "start" | "stretch";
type LineHeightRef1 =
  | "0"
  | "0.5"
  | "1"
...
type ObjectPositionRef1 = "bottom" | "top";
...
type PlaceContentRef1 =
  ...
  | "start"
  | "stretch";
type PlaceItemsRef1 = "baseline" | "center" | "end" | "start" | "stretch";
type PlaceSelfRef1 = "auto" | "center" | "end" | "start" | "stretch";
...
type BackgroundPositionBgleftLiteral = `bg-left-${BackgroundPositionRef1}`;
type BackgroundPositionBgrightLiteral = `bg-right-${BackgroundPositionRef2}`;
type BackgroundPositionBgLiteral = `bg-${BackgroundPositionRef3}`;
type BackgroundPositionValue =
  | BackgroundPositionBgleftLiteral
  | BackgroundPositionBgrightLiteral
...
type FilterBlurLiteral = `blur-${FilterRef1}` | "blur-3xl";
...
type FilterDropshadowLiteral = `drop-shadow-${FilterRef1}`;
type FilterGrayscaleLiteral = `grayscale-${FilterRef3}`;
type FilterHuerotateLiteral = `hue-rotate-${FilterRef4}`;
type FilterInvertLiteral = `invert-${FilterRef5}`;
type FilterSaturateLiteral = `saturate-${FilterRef6}`;
type FilterSepiaLiteral = `sepia-${FilterRef7}`;
type FilterValue =
  | "grayscale"
  | "invert"
  | "sepia"
...
type ContentValue = "content-none" | "content-none";
...
type ObjectPositionObjectleftLiteral = `object-left-${ObjectPositionRef1}`;
type ObjectPositionObjectrightLiteral = `object-right-${ObjectPositionRef2}`;
...
interface TailwindPerspective {
   ...
   * `Perspective`
   *
   * Utilities for controlling an element'ss perspective when placed in 3D
   * space.
   *
   * @see
